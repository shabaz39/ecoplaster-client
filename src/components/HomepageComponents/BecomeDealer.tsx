          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                Join our trusted dealer network and help us expand sustainable building solutions to new markets.
              </p>
              <form onSubmit={handleSubmit} className="space-y-4 text-black">
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-4 h-4 text-newgreen focus:ring-newgreen rounded"
                  />
                  <span>Send me notifications</span>
                </label>
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-newgreensecond text-white rounded-md hover:bg-newgreen transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-newgreen"
                >
